...
/* Generate calendar */
RAISERROR ('Inserting calendar into [Utility].[Calendar]', 0, 1) WITH NOWAIT

TRUNCATE TABLE [Utility].[Calendar]
EXECUTE [Utility].[GenerateCalendar] '2000-01-01', '2099-12-31'
