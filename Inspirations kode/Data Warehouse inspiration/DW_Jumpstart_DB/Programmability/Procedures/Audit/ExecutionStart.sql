...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Insert data
        -------------------------------------------------------
        INSERT INTO Audit.ExecutionLog ([ParentId], [PackageID], [PackageName], [ServerExecutionID], [StartTime], [EndTime], [Status], [UserName], [HostName])
        VALUES (@ParentId, @PackageId, @PackageName, @ServerExecutionID, GETDATE(), GETDATE(), @Status, SYSTEM_USER, HOST_NAME());
