CREATE TABLE [Load].[Fact_Ordre_2021]
(   [Bkey_Kunde]               INT                    NOT NULL,
	[Order_Id]                 INT                    NOT NULL,
	[Eval_Set]                 NVARCHAR(20)           NULL,
	[Order_Number]             SMALLINT               NOT NULL,
	[Year]                     SMALLINT               NOT NULL CHECK( [Year] = 2021),
...
CREATE CLUSTERED COLUMNSTORE INDEX CCI_Load_Fact_Ordre_2021 ON [Load].[Fact_Ordre_2021]
GO

CREATE  NONCLUSTERED  INDEX NCX_Bkey_Kunde_Bkey_Produkt ON [Load].[Fact_Ordre_2021] ( [Bkey_Kunde], [Bkey_Produkt] )
GO

CREATE  NONCLUSTERED  INDEX NCX_Year ON [Load].[Fact_Ordre_2021] ( [Year] )
GO