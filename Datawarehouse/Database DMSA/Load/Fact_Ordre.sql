...
CREATE NONCLUSTERED INDEX IDX_Ekey_Dim_Kunde ON [Load].[Fact_Ordre] ([Ekey_Kunde])
GO

CREATE NONCLUSTERED INDEX IDX_Ekey_Dim_Produkt ON [Load].[Fact_Ordre] ([Ekey_Produkt])
GO