CREATE TABLE [Prev].[Full_Data_Fact_Ordre_Columnstore_Index]
...
CREATE CLUSTERED COLUMNSTORE INDEX Prev_Full_Data_Fact_Ordre_Columnstore_Index ON [Prev].[Full_Data_Fact_Ordre_Columnstore_Index]

GO
CREATE  NONCLUSTERED  INDEX NCX_Bkey_Kunde_Bkey_Produkt ON [Prev].[Full_Data_Fact_Ordre_Columnstore_Index] ( [Bkey_Kunde], [Bkey_Produkt] )
GO