...
CREATE NONCLUSTERED INDEX IDX_Ekey_Dim_Kunde ON [Prev].[Fact_Ordre] ([Ekey_Kunde])
GO

CREATE NONCLUSTERED INDEX IDX_Ekey_Dim_Produkt ON [Prev].[Fact_Ordre] ([Ekey_Produkt])
GO