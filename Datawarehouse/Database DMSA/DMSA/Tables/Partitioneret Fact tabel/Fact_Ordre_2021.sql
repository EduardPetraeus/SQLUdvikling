CREATE TABLE [DMSA].[Fact_Ordre_2021]
...
CREATE CLUSTERED COLUMNSTORE INDEX CCI_DMSA_Fact_Ordre_2021 ON [DMSA].[Fact_Ordre_2021]
GO

CREATE  NONCLUSTERED  INDEX NCX_Bkey_Kunde_Bkey_Produkt ON [DMSA].[Fact_Ordre_2021] ( [Bkey_Kunde], [Bkey_Produkt] )
GO

CREATE  NONCLUSTERED  INDEX NCX_Year ON [DMSA].[Fact_Ordre_2021] ( [Year] )
GO