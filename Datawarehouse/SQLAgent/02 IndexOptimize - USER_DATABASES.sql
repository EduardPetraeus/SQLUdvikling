...
/****** Object:  Job [IndexOptimize - USER_DATABASES]    Script Date: 28-08-2019 15:28:47 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 28-08-2019 15:28:47 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - USER_DATABASES]    Script Date: 28-08-2019 15:28:47 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Sunday 12:30', 
		@enabled=1, 
		@freq_type=8, --hver uge 
		@freq_interval=1, -- Kører hver søndag.
		@freq_subday_type=1, 
