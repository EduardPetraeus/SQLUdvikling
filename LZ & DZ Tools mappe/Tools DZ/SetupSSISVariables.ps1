...
$LOGPATH = Join-Path -Path $LOGFOLDER -ChildPath "LOG_04_Databank-DZ_SSIS_SetupSSISVariables_ps1.log"
$LOGPATHERR = Join-Path -Path $LOGFOLDER -ChildPath "LOG_04_Databank-DZ_SSIS_SetupSSISVariables_ps1_err.log"
