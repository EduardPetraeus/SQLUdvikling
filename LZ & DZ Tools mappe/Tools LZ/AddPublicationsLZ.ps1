...
$LOGPATH = Join-Path -Path $LOGFOLDER -ChildPath "LOG_03_Databank-LZ_Database_0_AddPublications_ps1.log"

get-item AddPublicationsArticlesLZ.sql | %{
...
get-item AddPublicationsLZ.sql | %{
    Write-Host -ForegroundColor Green "Executing script: $($_.Name)"
    Write-Output "Executing script: $($_.Name)" | Add-Content -Path $LOGPATH
