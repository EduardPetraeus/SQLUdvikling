...
VALUES 
('BMAT-LZSQL-P01', 'RUT', 'SIMPLE'),
('BMAT-LZSQL-P01', 'RUT_ERST_LZ', 'SIMPLE'),
('BMAT-LZSQL-P01', 'CVRIntegration_Staging', 'SIMPLE'),
('BMAT-LZSQL-P01', 'Master Data Services', 'SIMPLE'),
('BMAT-LZSQL-P01', 'SSISDB', 'SIMPLE'),
('BMAT-LZSQL-P01', 'AES_ATP', 'SIMPLE'),
('BMAT-LZSQL-P01', 'ATIS', 'SIMPLE'),
('BMAT-LZSQL-P01', 'CPR', 'SIMPLE'),
('BMAT-LZSQL-P01', 'CVR', 'SIMPLE'),
('BMAT-LZSQL-P01', 'DAWA', 'SIMPLE'),
('BMAT-LZSQL-P01', 'Direktionsrapportering', 'SIMPLE'),
('BMAT-LZSQL-P01', 'LZDB', 'SIMPLE'),
('BMAT-LZSQL-P01', 'Staging', 'SIMPLE'),
('BMAT-LZSQL-P01', 'MDS', 'SIMPLE'),
('BMAT-LZSQL-P01', 'Metadatamodellen', 'SIMPLE'),
('BMAT-LZSQL-P01', 'Probas', 'SIMPLE')
;
